      ...
      <article className="w-full px-4 md:px-10 lg:px-16 py-10 md:py-16">
        ...
        <div className="section-reveal rounded-[28px] md:rounded-[36px] p-7 md:p-12" style={{ background: DARK }}>
          <div className="w-14 h-14 rounded-full flex items-center justify-center mb-6"
            ...
            <Icon name="Megaphone" size={26} style={{ color: MINT }} />
          </div>
          <h1 className="text-3xl md:text-5xl font-black tracking-tight mb-4 text-white">{t("promoTitle")}</h1>
          <p className="text-base md:text-lg leading-relaxed max-w-2xl" style={{ color: "rgba(255,255,255,0.72)" }}>{p.intro}</p>
