...
import { INK, SUB, LINE, ACCENT, PANEL, promotionPage } from "@/components/landing/theme";
    ...
    <div className="min-h-screen font-chinese" style={{ background: PANEL, color: INK }}>
      ...
      <article className="max-w-4xl mx-auto px-4 md:px-8 py-10 md:py-16">
        ...
        <div className="section-reveal">
          ...
          <h1 className="text-3xl md:text-5xl font-black tracking-tight mb-4" style={{ color: INK }}>Продвижение сайтов</h1>
        ...
        <section className="section-reveal mt-10 md:mt-14">
          <div className="card rounded-3xl overflow-hidden" style={{ background: "#fff", border: `1px solid ${LINE}`, boxShadow: "0 20px 50px rgba(17,19,24,0.08)" }}>
            <img src={p.preview} alt="Аналитика продвижения" className="w-full" style={{ objectFit: "cover" }} />
          </div>
          <p className="text-xs mt-3 text-center" style={{ color: SUB }}>Единая аналитика по всем рекламным каналам</p>
        </section>

        {/* what is */}
        <section className="section-reveal mt-12 md:mt-16">
          <h2 className="text-xl md:text-2xl font-black mb-4 tracking-tight" style={{ color: INK }}>Как это работает</h2>
          <p className="text-sm md:text-base leading-relaxed" style={{ color: SUB }}>{p.whatIs}</p>
        </section>

        {/* channels */}
        <section className="section-reveal mt-12 md:mt-16">
          <h2 className="text-xl md:text-2xl font-black mb-6 tracking-tight" style={{ color: INK }}>Рекламные каналы</h2>
        ...
        {/* audience */}
        <section className="section-reveal mt-12 md:mt-16">
          <h2 className="text-xl md:text-2xl font-black mb-6 tracking-tight" style={{ color: INK }}>Кому и чем полезно</h2>
        ...
        {/* benefits */}
        <section className="section-reveal mt-12 md:mt-16">
          <h2 className="text-xl md:text-2xl font-black mb-6 tracking-tight" style={{ color: INK }}>Почему это выгодно</h2>
          <div className="grid sm:grid-cols-2 gap-4">
            {p.benefits.map((b, i) => (
        ...
        {/* cases */}
        <section className="section-reveal mt-12 md:mt-16">
          <h2 className="text-xl md:text-2xl font-black mb-6 tracking-tight" style={{ color: INK }}>Результаты клиентов</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {p.cases.map((c, i) => (
              <div key={i} className="card p-6 rounded-2xl" style={{ background: "#fff", border: `1px solid ${LINE}` }}>
        ...
        <section className="section-reveal mt-12 md:mt-16">
          <div className="rounded-3xl p-6 md:p-12 text-center" style={{ background: INK, boxShadow: "0 24px 60px rgba(17,19,24,0.2)" }}>
            <h2 className="text-2xl md:text-4xl font-black mb-4 tracking-tight text-white">Готовы привлекать клиентов?</h2>
            <p className="text-sm md:text-base mb-8 max-w-lg mx-auto" style={{ color: "#9CA3AF" }}>
              Оставьте заявку — подберём каналы под вашу нишу, рассчитаем бюджет и запустим рекламу.
            </p>
            <Link to="/#contact"
